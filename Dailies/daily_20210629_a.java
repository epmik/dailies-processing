...
public class daily_20210629_a extends AbstractDaily 
{
  private float _xNoiseMultiplier = 0.0100F;
  private float _yNoiseMultiplier = 0.1000F;
  ...
  public void Draw(double elapsedTime) 
  {
    ...
    var index = Canvas.pixels.length - 1;

    var xmultiMultiplier = 1.000400D;
    var xmultiplier = 0.01D;
    var ymultiMultiplier = 1.000850D;
    var ymultiplier = 0.110D;

    for (var y = Canvas.height - 1; y > 0; y--) 
    {
      for (var x = 0.0; x < Canvas.width; x++) 
      {
        NoiseGenerator.InputMultiplier(xmultiplier, ymultiplier, 1.0);
      ...
      xmultiplier *= xmultiMultiplier;
      ymultiplier *= ymultiMultiplier;
