...
public class daily_20210616_b extends PApplet
{
  ...
  private float _warpDistance = 120F;
  ...
  public void draw() 
  {
    ...
    {
      _canvas.rect(ellipseOffset, y, _canvas.width - ellipseOffset - ellipseOffset, ellipseRadius);
    }
