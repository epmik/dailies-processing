...
public class daily_20210703_b extends AbstractDaily 
{
  private boolean _enableWarp = true;
  private int _warpStrength = 4;

  private int _numberOfColorFields = 5;
  ...
  public int _minMaxLineThickness = _maxMinLineThickness;
  ...
  public void setup() 
  {
    ...
    Gui.addNumberbox("_minMinLineThickness").setPosition(guiX, guiY).setLabel("Min minimum line thickness")
        .setValue(_minMinLineThickness).setScrollSensitivity(1).setMultiplier(1).setRange(_minMinLineThickness, _minMinLineThickness * 4)
    ...
    Gui.addNumberbox("_minMaxLineThickness").setPosition(guiX, guiY).setLabel("Min maximum line thickness")
        .setValue(_minMaxLineThickness).setScrollSensitivity(1).setMultiplier(1).setRange(_minMaxLineThickness, _minMaxLineThickness * 4)
        .onChange(changeColorFieldsThicknessAndDeviationCallbackListener);

    guiY += guiOffsetY;

    Gui.addNumberbox("_maxMaxLineThickness").setPosition(guiX, guiY).setLabel("Max maximum line thickness")
        .setValue(_maxMaxLineThickness).setScrollSensitivity(1).setMultiplier(1).setRange(_maxMaxLineThickness, _maxMaxLineThickness * 4)
        .onChange(changeColorFieldsThicknessAndDeviationCallbackListener);
