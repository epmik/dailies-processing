...
public class daily_20210707_a_explosion_weird_shape extends AbstractDaily 
{
  ...
  private void SetupRandomExplodeObjects()
  {
    ...
    {
      var line = RandomLine(_minLineLength, _maxLineOffset, RandomGenerator);
  ...
  class Line extends AbstractExplode
  {
    ...
    public void Draw(PGraphics canvas)
    {
      ...
      canvas.vertex(_x + _offsetvector[0] + _vector[0], _y + _offsetvector[1] + _vector[1], _z + _offsetvector[1] + _vector[2]);
