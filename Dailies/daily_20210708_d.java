...
public class daily_20210708_d extends AbstractDaily 
{
  ...
  private float _minLineOffset = 300.0f;
  ...
  private float _minDotOffset = 300.0f;
  ...
  private float _minTriangleOffset = 300.0f;
  private float _maxTriangleOffset = 1200.0f;

  private int _from1Color = color(0, 0, 0);
