...
public class daily_20210622_a extends AbstractDaily 
{
  ...
  public daily_20210622_a() 
  {
    ...
    _enableWarp = false;
    _warpStrength = (float) (10 * SketchResolutionMultiplier);
  ...
  public void setup() 
  {
    ...
    Gui.addSlider("_warpStrength").setPosition(guiX, guiY).setLabel("Warp strength").setRange(0, 200)
  ...
  public void Draw(double elapsedTime) 
  {
    ...
    var patchCount = 12;
    var canvasPadding = Canvas.width / 16;
