...
public class daily_20210702_b extends AbstractDaily 
{
  ...
  public void setup() 
  {
    ...
    _baseColor = Color20210703.Random(0.75, 0.75);
  ...
  private void SetupColorFields(boolean reset) 
  {
    ...
    var colors = Color20210703.Analagous(_baseColor);
