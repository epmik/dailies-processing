...
public class daily_20210630_d extends AbstractDaily 
{
  private boolean _enableWarp = true;
  private int _warpStrength = 10;

  private boolean _blackBackground = true;
  private boolean _enableFillColor = false;
  private boolean _enableStrokeColor = false;
  private boolean _enableFixedRadius = false;

  private int _numberOfTriangles = 16;
  private int _strokeWeight = 4;
