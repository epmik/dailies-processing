...
public class ExplodableAngledLineComponent extends AbstractExplodableComponent<ExplodableAngledLine>
{
  ...
  public ExplodableAngledLineComponent() 
  {
    super();
  ...
  public void SetupGui(ControlP5 gui, String tabtitle, int x, int y, int yoffset) 
  {
    ...
    SetupGuiForDefaultProperties(gui, tabtitle, guiOnChangeListener, x, y, yoffset);
  ...
  private void Colorize()
  {
    ...
    // var _from1ColorAlpha = Color.Alpha(_from1Color);
    // var _to1ColorAlpha = Color.Alpha(_to1Color);
    // var _from2ColorAlpha = Color.Alpha(_from2Color);
    // var _from3ColorAlpha = Color.Alpha(_from3Color);
