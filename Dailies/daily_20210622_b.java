...
public class daily_20210622_b extends AbstractDaily 
{
  ...
  public daily_20210622_b() 
  {
    super();

    ScreenWidth = 1024;
    ScreenHeight = 1024;
    SketchResolutionMultiplier = 4.0;
    _enableWarp = true;
    _warpStrength = (float) (ScreenWidth / 100 * SketchResolutionMultiplier);
