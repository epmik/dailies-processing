...
public class daily_20210711_a_explosion_cloud extends AbstractDaily 
{
  ...
  public class ExplodableIcosahedronCloud extends AbstractExplodable
  {
    ...
    public void Draw(PGraphics canvas) 
    {
      ...
      for (var i = _numberOfInnerClouds - 1; i > -1; i--)
      {
        ...
        DrawIcosahedron(canvas, x, y, z, radius, color, 0.15f, (float) _randomGenerator.Value() * radius);
    ...
    private void DrawIcosahedron(PGraphics canvas, float x, float y, float z, float radius, int color, float maxalpha, float random)
    {
      canvas.pushMatrix();
      ...
      for (var i = 0; i < _icosahedron.TriangleIndices.size(); i += 3) 
      {
        ...
        var alpha = (float) Math
            .Clamp(Math.Map(_noiseGenerator.Value(p.X + random, p.Y + random, p.Z + random), 0, 1, -0.25, 1.25))
            * maxalpha * 255;
  
        canvas.fill(Color.RgbToInt(Color.Red(color), Color.Green(color), Color.Blue(color), alpha));
  ...
  public class ExplodableIcosahedronCloudComponent extends AbstractExplodableComponent<ExplodableIcosahedronCloud>
  {
    ...
    public int _from1Color = Color.RgbToInt(255, 255, 255);
    private controlP5.ColorPicker _from1ColorColorPicker;
  
    // public int _to1Color = Color.RgbToInt(2, 24, 45);
    public int _to1Color = Color.RgbToInt(240, 240, 240);
  ...
  public daily_20210711_a_explosion_cloud() 
  {
    super();
  ...
  public void setup() 
  {
    ...
    _explodableIcosahedronCloudComponent._minRadius = 300;
