...
public class daily_20210706_a extends AbstractDaily 
{
  ...
  public void Draw(double elapsedTime) 
  {
    ...
    for (var l = 0; l < 200; l++)
    {
      ...
      var h = RandomGenerator.Value(_minLeafHeight, _maxLeafHeight);

      // Canvas.fill(0);
      // Canvas.circle(0, 0, 5);
  
      DrawRandomShapedLeaf(
          x,
          y,
          a,
          h,
  ...
  private void DrawShapedLeaf1(
    ...
    PGraphics canvas)
  {
    height = randomGenerator.Value(60, 80);
    var maxheight = 80;
    var m = maxheight / height;
    ...
    var middle = randomGenerator.Value(40, 46);
    var halfWidth = randomGenerator.Value(32.5, 38.5);
    var halfvariation = randomGenerator.Value(7.5, 11.5);
