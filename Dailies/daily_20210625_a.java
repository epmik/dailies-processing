...
public class daily_20210625_a extends AbstractDaily 
{
  ...
  public void Draw(double elapsedTime) 
  {
    ...
    DrawLandscape(Canvas, NoiseGenerator, cloudColorPickRow);
  ...
  private void DrawBackgroundGradient(PGraphics canvas, INoiseGenerator noiseGenerator) 
  {
    ...
    if (_enableWarp) {
      Warp(canvas, _warpStrength * 2, noiseGenerator);
    }
