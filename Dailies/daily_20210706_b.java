...
public class daily_20210706_b extends AbstractDaily 
{
  ...
  private int _numberOfLeaves = 600;

  public daily_20210706_b() 
  {
    super();
  ...
  private int RandomLeafColor(IRandomGenerator randomGenerator)
  {
    ...
    var s = randomGenerator.Value(0.02, 0.05);
    var b = randomGenerator.Value(0.90, 0.96);
