...
public class daily_20210707_e extends AbstractDaily 
{
  ...
  public void setup() 
  {
    ...
    // _colorPickerArrayList.add(new ColorPicker());

    _colorPickerArrayList.add(
      ColorPicker.FromHsb(
        RandomGenerator.Value(),
        0.0, 
        RandomGenerator.Value(0.00, 0.75), RandomGenerator));

    // _colorPickerArrayList.add(
    //   new ColorPicker(
    //     Color.HsbToInt(Color.DegreesToDouble(RandomGenerator.Value(13, 48)),
    //     RandomGenerator.Value(0.30, 0.95), 
    //     RandomGenerator.Value(0.30, 0.95)),
    //     Color.HsbToInt(Color.DegreesToDouble(RandomGenerator.Value(13, 48)),
    //     RandomGenerator.Value(0.30, 0.95), 
    //     RandomGenerator.Value(0.30, 0.95))));
    ...
    // _colorPickerArrayList.add(
    //   new ColorPicker(
    //     Color.HsbToInt(Color.DegreesToDouble(RandomGenerator.Value(251, 271)),
    //     RandomGenerator.Value(0.30, 0.95), 
    //     RandomGenerator.Value(0.30, 0.95)),
    //     Color.HsbToInt(Color.DegreesToDouble(RandomGenerator.Value(251, 271)),
    //     RandomGenerator.Value(0.30, 0.95), 
    ...
    // _colorPickerArrayList.add(
    //   new ColorPicker(
    //     Color.HsbToInt(Color.DegreesToDouble(RandomGenerator.Value(72, 92)),
    //     RandomGenerator.Value(0.30, 0.95), 
    //     RandomGenerator.Value(0.30, 0.95)),
    //     Color.HsbToInt(Color.DegreesToDouble(RandomGenerator.Value(72, 92)),
    //     RandomGenerator.Value(0.30, 0.95), 
  ...
  private void SetupRandomExplodeObjects()
  {
    for (var i = 0; i < _numberOfLines; i++)
    {
      ...
      line.ColorOrigin(colorPicker.RandomColor());
      line.ColorExtent(colorPicker.RandomColor());
    ...
    for (var i = 0; i < _numberOfDots; i++)
    {
      ...
      dot.Color(colorPicker.RandomColor());
