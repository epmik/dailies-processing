 ...
 */
public class SuperSimplexNoiseGenerator implements INoiseGenerator {
	...
	public double Value(double x) 
	{
		...
		{
			value += noise2(x * frequency, x * frequency) * amplitude;
	...
	public double Value(double x, double y, double z) 
	{
		...
		for (var c = 0; c < Octaves(); c++)
		{
			value += noise3_Classic(x * frequency, y * frequency, z * frequency) * amplitude;
	...
	public double Value(double x, double y, double z, double w) 
	{
		...
		for (var c = 0; c < Octaves(); c++)
		{
			value += noise4_Classic(x * frequency, y * frequency, z * frequency, w * frequency) * amplitude;
