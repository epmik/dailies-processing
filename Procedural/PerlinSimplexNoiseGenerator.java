...
public class PerlinSimplexNoiseGenerator implements INoiseGenerator 
{
...
new Grad(1,1,1,0),new Grad(1,1,-1,0),new Grad(1,-1,1,0),new Grad(1,-1,-1,0),
	...
	public PerlinSimplexNoiseGenerator() 
	{
		ReSeed();
	}
	
	// public PerlinSimplexNoiseGenerator(short[] perm) {
	// 	_perm = perm;
	...
	public PerlinSimplexNoiseGenerator(long seed) 
	{
		ReSeed(seed);
	}
...
// Inner class to speed upp gradient computations
  ...
  private static class Grad
  {
	...
	/// <summary> assumes value is between -1 and 1 and the return value is ranged between 0 and 1 </summary>
	...
	public double Value(double x) 
	{
		...
		{
			value += Compute(x * frequency, x * frequency) * amplitude;
  ...
  // 2D simplex noise
  public static double Compute(double xin, double yin) {
  ...
  // 3D simplex noise
  public static double Compute(double xin, double yin, double zin) {
